...
export default function OrderTrackingPage() {
  ...
  const orders: Order[] = [
    ...
    },
    {
      ...
      date: '2024-05-15',
      items: [
        { id: '4', product: 'Battery', quantity: 1, price: 12000 },
      ],
      total: 15500,
      status: 'processing',
  ...
  return (
    <div style={{ backgroundColor: colors.background, minHeight: '100vh', color: colors.text }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 2rem' }}>
        <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', marginBottom: '0.5rem' }}>Order Tracking</h1>
        <p style={{ color: colors.textSecondary, marginBottom: '2rem' }}>Monitor your parts orders in real-time</p>
            ...
            {orders.map((order) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div>
                      <p style={{ color: colors.textSecondary, fontSize: '0.875rem', margin: 0 }}>Order ID</p>
                      <p style={{ color: colors.accent, fontWeight: 'bold', fontSize: '1rem', margin: '0.25rem 0 0 0' }}>
                        {order.id}
                      </p>
                    </div>
                    <div>
                      <p style={{ color: colors.textSecondary, fontSize: '0.875rem', margin: 0 }}>Order Date</p>
                      <p style={{ color: colors.text, fontWeight: '600', margin: '0.25rem 0 0 0' }}>
                        {formatDate(order.date)}
                      </p>
                    </div>
                    <div>
                      <p style={{ color: colors.textSecondary, fontSize: '0.875rem', margin: 0 }}>Total</p>
                      <p style={{ color: colors.accent, fontWeight: 'bold', fontSize: '1rem', margin: '0.25rem 0 0 0' }}>
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.5rem' }}>
                      ...
                      <span style={{ color: status.color, fontWeight: '600', textTransform: 'capitalize' }}>
                        {order.status}
                      </span>
                    </div>
                    ...
                    {order.estimatedDelivery && (
                      <p style={{ color: colors.textSecondary, fontSize: '0.875rem', margin: '0.5rem 0 0 0' }}>
                  ...
                  >
                    <p style={{ fontSize: '0.875rem', fontWeight: '600', marginBottom: '0.75rem', margin: 0 }}>
                    ...
                    {order.items.map((item) => (
                      ...
                      >
                        <div>
                          <p style={{ margin: 0, color: colors.text }}>{item.product}</p>
                          <p style={{ margin: '0.25rem 0 0 0', color: colors.textSecondary, fontSize: '0.75rem' }}>
                            Qty: {item.quantity}
                          </p>
                        </div>
                        <p style={{ margin: 0, color: colors.accent, fontWeight: '600' }}>{formatKES(item.price)}</p>
                      </div>
                    ))}
                  </div>
                </div>
