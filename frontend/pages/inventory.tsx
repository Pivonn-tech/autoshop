...
export default function Inventory() {
  ...
  const applyFilters = (productsToFilter: Product[], filterState: FilterState) => {
    ...
    <div style={{ backgroundColor: colors.background, color: colors.text, minHeight: '100vh' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }}>
          <Link href="/inventory" style={{ color: colors.accent, textDecoration: 'none', cursor: 'pointer', fontWeight: 'bold' }}>
            Inventory
          </Link>
      ...
      <div style={{ display: 'flex', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        >
          <h3 style={{ fontSize: '1.3rem', fontWeight: 900, marginBottom: '1.5rem', color: colors.accent }}>
            FILTERS
          </h3>

          {/* Price Range */}
          <div style={{ marginBottom: '2rem' }}>
            <label style={{ display: 'block', fontWeight: 900, marginBottom: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em', fontSize: '0.9rem' }}>
              Price Range
            </label>
            <input
              type="range"
            ...
            />
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', color: colors.textSecondary }}>
              <span>Ksh 0</span>
