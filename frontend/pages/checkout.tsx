      ...
      <div style={{ display: 'flex', minHeight: 'calc(100vh - 70px)' }}>
        ...
        >
          ...
          <div style={{ marginBottom: '3rem' }}>
            <h2 style={{ fontSize: '1.3rem', fontWeight: 900, marginBottom: '1.5rem', color: colors.accent, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Shipping Address
            </h2>
        ...
        >
          <h2 style={{ fontSize: '1.5rem', fontWeight: 900, marginBottom: '2rem', color: colors.accent, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
            Order Summary
          </h2>
          ...
          <div style={{ flex: 1, marginBottom: '2rem' }}>
            {cartItems.map((item) => (
              ...
              >
                ...
                <p style={{ fontWeight: 900, color: colors.accent, fontSize: '1.1rem' }}>
          ...
          {/* Summary Lines */}
          <div style={{ paddingTop: '2rem', borderTop: `2px solid ${colors.accent}`, marginBottom: '2rem' }}>
            <div
              style={{
                display: 'flex',
                justifyContent: 'space-between',
          ...
          <button
            ...
            onClick={() => alert('Order placed! Order confirmation has been sent to your email.')}
          >
            Place Order
          </button>

          <Link href="/parts" style={{ textDecoration: 'none', textAlign: 'center' }}>
            <button
              style={{
                width: '100%',
                backgroundColor: colors.background,
          ...
          >
            <p style={{ color: colors.accent, fontWeight: 900, marginBottom: '0.5rem' }}>
              ✓ Secure Checkout
            </p>
            <p style={{ color: colors.textSecondary, fontSize: '0.85rem' }}>
